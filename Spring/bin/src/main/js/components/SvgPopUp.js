        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {props.hoverSvgPopupData.EQUAL_POPULATION_VARIANCE.toFixed(2)}%
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {props.hoverSvgPopupData.POLITICAL_DEVIATION_FROM_ENACTED.toFixed(2)}%
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {props.hoverSvgPopupData.RACIAL_DEVIATION_FROM_ENACTED.toFixed(2)}%
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        {props.hoverSvgPopupData.EFFICIENCY_GAP[props.electionIndex] ? props.hoverSvgPopupData.EFFICIENCY_GAP[props.electionIndex].toFixed(2) + '%' : 'n/a'}
                    </td>
                </tr>
                <tr>
                    <td>
