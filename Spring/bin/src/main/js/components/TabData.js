            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div className='tool-tip-wrapper'>Equal Population Variance
                                <div
                                    ...
                                    onMouseEnter={(e) => {
                                        props.setTooltipOpen(true);
                                        props.setTooltipText('The mean sum of squares percentage difference between a district\'s population and the ideal district population for the state. Lower is better.');
                                        props.setToolTipPosition([(e.clientX - 250) + 'px', (e.clientY) + 'px']);
                                    }}
                                    onMouseLeave={() => {
                                        console.log("leaving");
                        ...
                        <td className={'td-align-right'}>{props.districting.Measures.EQUAL_POPULATION_VARIANCE.toFixed(2)}%</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td className={'td-align-right'}>{props.districting.Measures.POLITICAL_DEVIATION_FROM_ENACTED.toFixed(2)}%</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td className={'td-align-right'}>{props.districting.Measures.RACIAL_DEVIATION_FROM_ENACTED.toFixed(2)}%</td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td className={'td-align-right'}>{props.districting.Measures.GRAPH_COMPACTNESS.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td className={'td-align-right'}>{props.districting.Measures.EFFICIENCY_GAP[props.electionIndex] ? props.districting.Measures.EFFICIENCY_GAP[props.electionIndex].toFixed(2) + '%' : 'n/a'}</td>
                    </tr>
                    <tr>
                        <td>
    ...
    return <div className="tab-wrapper">
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type='text' onBlur={(e) => props.setAlgorithmParameters({ ...props.algorithmParameters, timeout: e.target.value })}></input>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <tbody>
                {distData.map((dist) => (
                    <tr key={dist.districtNumber}>
                        ...
                        <td className={"td-align-left " + (dist.elections[props.electionIndex].votes.REPUBLICAN_PARTY > dist.elections[props.electionIndex].votes.DEMOCRATIC_PARTY ? 'Rep' : 'Dem')}>
                            {dist.elections[props.electionIndex].votes.REPUBLICAN_PARTY > dist.elections[props.electionIndex].votes.DEMOCRATIC_PARTY ? 'Rep.' : 'Dem.'}
                        </td>
        ...
        {distData.map((dist) => (
            <div key={dist.districtNumber} className="district-measures" id={"district-measures-" + (dist.districtNumber)}
                ...
                <h4 className="district-measure-text-standalone">2020 House Election Winner Party: &nbsp;
                    <span className={"district-measure-text-standalone party " + (dist.elections[props.electionIndex].votes.REPUBLICAN_PARTY > dist.elections[props.electionIndex].votes.DEMOCRATIC_PARTY ? 'Rep' : 'Dem')}>{dist.elections[props.electionIndex].votes.REPUBLICAN_PARTY > dist.elections[props.electionIndex].votes.DEMOCRATIC_PARTY ? 'Rep.' : 'Dem.'}</span>
                </h4>
                ...
                <div className={props.isRightCollapsedOrExpanded === 'expanded' ? 'district-measures-expanded' : ''}>
                    <div style={{ flex: props.isRightCollapsedOrExpanded === 'expanded' ? '55%' : '' }}>
                        ...
                        {props.isRightCollapsedOrExpanded === 'expanded' && <div><h4>Polsby - Popper Compactness Score: {dist.polsbyPopper.toFixed(2)}</h4>
                            <h4>Graph Theoretical Compactness Score: {dist.graphCompactness.toFixed(2)}</h4>
                        </div>}
                    </div>
