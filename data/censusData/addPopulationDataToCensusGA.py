...
# csv file name
filename = "./georgia/ga-block-data.csv"
...
with open("../electionData/georgia/2020/ga_2020_election_house_fixed_2.json") as f:
  dataElection = json.load(f)
with open("./georgia/ga_block_with_pr_all_eli.json") as f:
...
with open("./georgia/ga_block_with_pr_and_pop.json", 'w') as outfile:
    json.dump(dataCensus, outfile, indent=1)
with open("./districts/georgia_dist_pop.json", 'w') as outfile:
    json.dump(districtCounts, outfile, indent=1)
with open("../electionData/georgia/2020/ga_2020_election_house_2_and_pop.json", 'w') as outfile:
