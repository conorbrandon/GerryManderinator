...
# csv file name
filename = "./arizona/az_block_data.csv"
...
with open("../electionData/arizona/2020/az_2020_election_house_fixed_2.json") as f:
  dataElection = json.load(f)
with open("./arizona/az_block_with_pr.json") as f:
...
with open("./arizona/az_block_with_pr_and_pop.json", 'w') as outfile:
    json.dump(dataCensus, outfile, indent=1)
with open("./districts/arizona_dist_pop.json", 'w') as outfile:
    json.dump(districtCounts, outfile, indent=1)
with open("../electionData/arizona/2020/az_2020_election_house_2_and_pop.json", 'w') as outfile:
