...
with open("./nevada/nv_block_with_pr_and_pop_and_hispanic.json") as f:
  dataPop = json.load(f)
with open("./nevada/nv_block_with_pr-wow.json") as f:
...
for block in range(len(dataBlock["features"])):
    ...
    count += 1
    print(count, block)
with open("./nevada/nv_block_with_pr_and_pop-wow.json", 'w') as outfile:
